...
export const PINS = [
  { id: 1,  city: "Praha",      country: "CZ", lon: 14.43, lat: 50.08, project: "Národní muzeum — rekonstrukce", year: 2024, units: 412, area: "VZT komponenty", sector: "Kultura", featured: true },
  { id: 2,  city: "Brno",       country: "CZ", lon: 16.61, lat: 49.20, project: "Spielberk Office Centre",       year: 2023, units: 188, area: "VZT komponenty", sector: "Administrativa" },
  { id: 3,  city: "Bratislava", country: "SK", lon: 17.11, lat: 48.15, project: "Eurovea II — Tower",            year: 2024, units: 261, area: "VZT komponenty", sector: "Výškové budovy" },
  ...
  { id: 5,  city: "Berlín",     country: "DE", lon: 13.40, lat: 52.52, project: "Sony Center — retrofit",        year: 2023, units: 320, area: "VZT komponenty", sector: "Administrativa" },
  { id: 6,  city: "Mnichov",    country: "DE", lon: 11.58, lat: 48.14, project: "BMW Welt — VZT",                year: 2024, units: 174, area: "VZT komponenty", sector: "Průmysl", featured: true },
  ...
  { id: 8,  city: "Varšava",    country: "PL", lon: 21.01, lat: 52.23, project: "Varso Tower",                   year: 2022, units: 615, area: "VZT komponenty", sector: "Výškové budovy", featured: true },
  ...
  { id: 10, city: "Londýn",     country: "GB", lon: -0.13, lat: 51.51, project: "22 Bishopsgate (PKI-EI)",       year: 2023, units: 1340, area: "VZT komponenty", sector: "Výškové budovy", featured: true },
  ...
  { id: 17, city: "Atény",      country: "GR", lon: 23.73, lat: 37.98, project: "Letiště Eleftherios Venizelos", year: 2023, units: 360, area: "VZT komponenty", sector: "Infrastruktura" },
  ...
  { id: 19, city: "Bukurešť",   country: "RO", lon: 26.10, lat: 44.43, project: "One Cotroceni Park",            year: 2024, units: 305, area: "VZT komponenty", sector: "Administrativa" },
  { id: 20, city: "Sofia",      country: "BG", lon: 23.32, lat: 42.70, project: "Sofia Tech Park",               year: 2024, units: 132, area: "VZT komponenty", sector: "Technol. kampusy" },
  ...
  { id: 22, city: "Lyon",       country: "FR", lon:  4.84, lat: 45.76, project: "Confluences — Tower",           year: 2023, units: 152, area: "VZT komponenty", sector: "Výškové budovy" },
  ...
  { id: 26, city: "Tallin",     country: "EE", lon: 24.75, lat: 59.44, project: "Maakri kvartál",                year: 2025, units: 88,  area: "VZT komponenty", sector: "Administrativa" },
  ...
  { id: 30, city: "Manchester", country: "GB", lon: -2.24, lat: 53.48, project: "Co-op Live Arena",              year: 2024, units: 410, area: "VZT komponenty", sector: "Infrastruktura" },
  { id: 31, city: "Dublin",     country: "IE", lon: -6.27, lat: 53.35, project: "Capital Dock — kanceláře",      year: 2023, units: 180, area: "VZT komponenty", sector: "Administrativa" },
  ...
  return (
    <div className="relative hairline overflow-hidden" style={{ height, background: bg }}>
      ...
      <div className={`absolute left-5 bottom-12 hairline px-4 py-3 flex items-center gap-5 mono text-[11px] ${variant === "dark" ? "bg-mandik-ink text-white/85" : "bg-white text-mandik-steel"}`}>
        <div className="flex items-center gap-2"><span className="w-2.5 h-2.5" style={{ background: "#74d1ea" }} />VZT</div>
